...
<vbox> 
 <vbox>
  ...
  <hbox>
	...
	<action>mx-viewer http://mepiscommunity.org/wiki/help-files/help-live-remasterpersistence-remastercc &</action>
	</button>
        <text><label>"            "</label></text>
	<pixmap>
        <height>32</height>
        <width>32</width>
	<input file>"/usr/share/mx-remaster/icons/mxfcelogo.png"</input>
	</pixmap>
        <text><label>"            "</label></text>
	<button>
	<label>"Close"</label>
